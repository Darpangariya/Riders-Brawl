...
namespace BNG
{
    public class SteeringWheelBike : GrabbableEvents
    {

        [Header("Rotation Limits")]
        [Tooltip("Maximum Y value in Local Euler Angles. Can be < -360. Ex : -450")]
        ...
        public virtual void UpdateAngleCalculations()
        {
            ...
            if (PrimaryGrabber)
            {
                ...
                rotatePosition = new Vector3(rotatePosition.x, 0, rotatePosition.z);
        ...
        {
            RotatorObject.localEulerAngles = new Vector3(0, angle, 0);
        }
        ...
        public override void OnGrab(Grabber grabber)
        {
            ...
            if (grabber == SecondaryGrabber)
            {
                ...
                // Discard the Z value
                previousSecondaryPosition = new Vector3(previousSecondaryPosition.x, 0, previousSecondaryPosition.z);
            }
            // Primary
            else
            {
                ...
                // Discard the Z value
                previousPrimaryPosition = new Vector3(previousPrimaryPosition.x, 0, previousPrimaryPosition.z);
            }
        }
